...
<html>
<head>
	<title> Official Account GrandMa Recipe </title>
	...
	<style type="text/css">
		...
		*{ margin: 0px; padding: 0px; font-family: sans-serif;
		...
		p{ padding-right: 8%; padding-left: 8%; color: white; font-size: 25px; font-family: fantasy;}
...
<body>
	...
	<div class="main">
	<br><br><h1 class="normal"> OFFICIAL ACCOUNT </h1><br><br>
	<p align="center"> INSTAGRAM <br> GrandMaRecipe_ </p><br>
	<p align="center"> TWITTER <br> @GrandmaRecipeOffical </p><br>
	<p align="center"> CHANNEL YOUTUBE <br> GrandMa Recipe </p>
		<br><br>
	</div>
</body>
</html>
...
<html>
<head>
	<title> Resep Asinan Jakarta with GrandMa Recipe </title>
...
<body>
	...
	<div class="main">
	<br><br><h1 class="normal"> Resep Asinan Jakarta </h1><br><br>
	<img src="asinanjakarta.jpg" width="300px" height="200px" style="display: block; margin: auto;">
	<br><br>
	<p style="text-align: justify; text-indent: 0.5in;"> Asinan adalah sejenis makanan yang dibuat dengan cara pengacaran (melalui pengasinan dengan garam atau pengasaman dengan cuka), bahan yang diacarkan yaitu berbagai jenis sayuran dan buah-buahan. Asinan adalah salah satu hidangan khas seni kuliner Indonesia. Istilah asin mengacu kepada proses pengawetan dengan merendam buah atau sayur dalam larutan campuran air dan garam. Asinan sangat mirip dengan rujak, perbedaan utamanya antara lain bahan rujak disajikan segar, sedangkan bahan asinan disajikan dalam keadaan diasinkan atau diacar. Sebelum memasak Asinan Jakarta ada beberapa bahan - bahan yang perlu disiapkan. </p>
	<br>
	<p> Bahan - Bahan : <br> 1. 250gr buah Kol, taoge <br> 2. 250gr Lobak <br> 3. 1 unting Sawi <br> 4. 1 buah Wortel <br> 5. 1 buah Ketimun <br> 6. 250 gr Daun selada <br> 7. 1 unting Kacang tanah <br> 8. Cabai merah, dihaluskan (sesuai seler) <br> 9. Cuka, garam, dan gula pasir secukupnya</p>
	<br>
	<p  style="text-align: justify;"> Cara membuat Asinan Jakarta : </p>
	<p> 1. Kol dirajang halus. <br> 2. Sawi, lobak, wortel yang sudah dihaluskan <br> 3. Ketimun dipotong - potong, begitu pula daun selada sedikit saja. <br> 4. Campurkan cabai halus dengan kacang dan tambahkan air panas. <br> 5. Tambahkan cuka, gula pasir, dan garam secukupnya aduk rata sampai rata. <br> 6. Sayur tadi taruh diatas piring, kemudian tuangkan bumbu kacang diatasnya. <br> 7. Hidangkan, bila suka tambahkan kerupuk yang sudah diremat-remat.</p>
	<br><br>
